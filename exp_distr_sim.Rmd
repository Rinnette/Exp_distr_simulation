...
The histogram shows the variability of the sample means. The centre of the distribution of the variances is about 24.9 which is almost the same as the theoretical mean of 25.  The lines showing the x intercept of these figures are almost on top of each other as the values are very close.
